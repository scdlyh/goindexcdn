...
5. Download `index.js` in https://raw.githubusercontent.com/scdlyh/goindexcdn/master/go2index/index.js  and replace `client_id`,`client_secret`,`refresh_token` for what you just got.
